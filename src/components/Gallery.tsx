  ...
  if (data.type === 'instagram') {
    return (
      <a 
        ...
        className="block bg-gradient-to-br from-purple-600 via-pink-500 to-orange-400 rounded-lg p-8 flex flex-col items-center justify-center text-white hover:scale-105 transition-transform duration-300"
        style={{ height: '300px' }}
      >
        ...
        <p className="text-xl font-bold mb-2">More Photos</p>
